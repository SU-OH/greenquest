  ...
  return (
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-green-50 overflow-y-auto">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Log in to GreenQuest</h2>
        <p className="mt-2 text-center text-sm text-gray-600">Continue your environmental journey</p>
      </div>
